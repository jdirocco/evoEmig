...
public class WebappSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WebappPackage.COLLECTION: {
				Collection collection = (Collection)theEObject;
				T result = caseCollection(collection);
				if (result == null) result = caseData(collection);
				if (result == null) result = caseNamedElement(collection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebappPackage.DATA: {
			...
			case WebappPackage.ROUTER: {
				Router router = (Router)theEObject;
				T result = caseRouter(router);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebappPackage.TEMPLATE: {
				Template template = (Template)theEObject;
				T result = caseTemplate(template);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebappPackage.MODEL_ATTRIBUTE: {
				ModelAttribute modelAttribute = (ModelAttribute)theEObject;
				T result = caseModelAttribute(modelAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebappPackage.ROUTER_BINDING: {
				RouterBinding routerBinding = (RouterBinding)theEObject;
				T result = caseRouterBinding(routerBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case WebappPackage.PAGE_CONTROLLER: {
				PageController pageController = (PageController)theEObject;
				T result = casePageController(pageController);
				if (result == null) result = caseController(pageController);
				if (result == null) result = caseNamedElement(pageController);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Router Binding</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Router Binding</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRouterBinding(RouterBinding object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Page Controller</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Page Controller</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePageController(PageController object) {
		return null;
	}
