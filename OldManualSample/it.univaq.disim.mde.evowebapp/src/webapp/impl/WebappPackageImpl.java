...
import webapp.ServiceController;
import webapp.Style;
...
public class WebappPackageImpl extends EPackageImpl implements WebappPackage {
	 ...
	 * @generated
	 */
	private EClass serviceControllerEClass = null;
	 ...
	 * @generated
	 */
	public EReference getTemplate_Style() {
	 ...
	 * @generated
	 */
	public EClass getServiceController() {
		return serviceControllerEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getStyle_StyleRules() {
	...
	public void createPackageContents() {
		...
		createEReference(templateEClass, TEMPLATE__STYLE);
		...
		serviceControllerEClass = createEClass(SERVICE_CONTROLLER);

		styleEClass = createEClass(STYLE);
		createEAttribute(styleEClass, STYLE__STYLE_RULES);
	...
	public void initializePackageContents() {
		...
		serviceControllerEClass.getESuperTypes().add(this.getController());
		styleEClass.getESuperTypes().add(this.getNamedElement());
		...
		initEReference(getTemplate_Style(), this.getStyle(), null, "style", null, 0, 1, Template.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(serviceControllerEClass, ServiceController.class, "ServiceController", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(styleEClass, Style.class, "Style", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStyle_StyleRules(), ecorePackage.getEString(), "styleRules", null, 0, -1, Style.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
